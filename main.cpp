...
class Graph
{
 ...
 public:
  ...
  int num_max_out_degree_index(int num){
	  ...
	  return out_degree_index_rank[num];
  }

  void instant_selective_impulse(int num_neurons){
	  for(int i = 0; i < num_neurons; ++i){
		  set_state(num_max_out_degree_index(i), 1);
	  } 
  }
  ...
  //Return average and activation syncs in a vector, with exited neurons
